<?php 
    if($_POST){
        ...
        //Función mover un archivo con el mismo nombre
        //temporal names , nombres temporales , copiar con el mismo nombre 
...
<body>
    ...
    <form action="ejercicio41.php" enctype="multipart/form-data" method="post">
        Imagen:
